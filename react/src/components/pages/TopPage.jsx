...
const TopPage = () => {
  ...
  const handleExcelClick = () => {
    navigate('/excel-output');
  }

  return (
      <>
        <HeaderCompornent />
        <div className="grid sm:grid-cols-2 grid-cols-1 px-14 sm:py-52 py-12 gap-5 sm:text-5xl text-3xl">
            ...
            <button onClick={handleExcelClick} className=" bg-green-500 hover:bg-green-300 text-white font-bold rounded py-10">EXCEL出力</button>
          </div>
      </>
  );
};
